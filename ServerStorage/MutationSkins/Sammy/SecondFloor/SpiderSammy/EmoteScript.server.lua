--[[
    EmoteScript (Script)
    Path: ServerStorage → MutationSkins → Sammy → SecondFloor → SpiderSammy
    Parent: SpiderSammy
    Properties:
        Disabled: false
...
--This script is made by me (SMARTGAMER0007)
local animationid =  15122972413--Enter the emote id here :D
